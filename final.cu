// Параллельный prefix-sum (scan) на CPU и GPU
// Нужно реализовать алгоритм префиксных сумм (inclusive) для массива:
// 1. Базовую последовательную версию
// 2. Параллельную CPU-версию (OpenMP)
// 3. CUDA-версию (двухфазный scan по блокам + перенос сумм блоков)
// обязательно сделать проверку корректности на нескольких размерах данных и сравнение времени выполнения и speedup.
...
// ============================================================
// Каждый элемент выходного массива — это сумма всех предыдущих элементов входного массива, включая текущий
